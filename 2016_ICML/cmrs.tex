...
cases, MRS produces fewer outliers with high immediate regret than ES. We provide empirical
...
``immediate regret'' denotes the difference of function value of the selected solution to 
true the optimal function value. BO
aims at finding such a solution of minimum immediate regret while  minimizing at the same
