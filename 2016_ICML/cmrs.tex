...
\caption{(Top) Median and mean immediate regret over $250$ repetitions for different acquisition functions. Shown is the immediate regret of the recommendation $\mathbf{\tilde x}_N$ after $N$ trials, i.e., the point which maximizes the GP posterior
mean. (Bottom) Histogram of the immediate regret after performing $N=100$ trials for different acquisition functions (note the log-scales).}
...
the same level of mean and median immediate regret  as MRS after $N=200$ steps 
